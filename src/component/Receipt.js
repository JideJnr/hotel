...
const Receipt = ({data,user}) => {
  ...
  {data && data.inUse ? (
    <Button label='Checking out' onClick={handleUpdate}/>
  ) : (
    <p>Checked Out</p>
  )}
</>
